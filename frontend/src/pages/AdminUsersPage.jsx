...
const AdminUsersPage = () => {
    ...
    const fetchLoans = async () => {
      try {
        const response = await axios.post(
          `${import.meta.env.VITE_BACKEND_URL}/api/admin/get-all-loans`,
          {},
          { headers }
        );
    ...
    const fetchUsers = async () => {
      try {
        const res = await axios.post(
          `${import.meta.env.VITE_BACKEND_URL}/api/admin/get-users`,
          {},
          { headers }
        );
        ...
        for (const user of nonAdmins) {
          try {
            const userDetails = await axios.post(
              `${import.meta.env.VITE_BACKEND_URL}/api/admin/get-user/${user._id}`,
              {},
              { headers }
            );
  ...
  const handleRowClick = async (userId) => {
    try {
      const res = await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/api/admin/get-user/${userId}`,
        {},
        { headers }
      );
